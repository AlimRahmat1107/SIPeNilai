...
@section('container')
    <div class="w-full mt-6 pl-0 lg:pl-2">
        ...
        <div class="leading-loose">
            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('courses.store') }}" method="POST"
                ...
                <div class="flex w-full justify-between mt-2">
                    <div class="w-[40%]">
                        ...
                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="name">Matakuliah</label>
                        ...
                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="code">Kode Matakuliah</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="code" name="code"
                                type="text" required placeholder="Masukan Jurusan">
                        </div>
