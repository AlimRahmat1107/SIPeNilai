...
@section('container')
    <div class="w-11/12 mt-6 ml-10">
        <div class="mb-2 flex justify-between">
            ...
            <div>
            <a href="/enrollment/create" class=" text-white block rounded-2xl py-2 px-4 border border-amber-300 bg-blue-400"> <i class="fas fa-plus"></i>  data</a>
        </div>
        </div>
            ...
            <table class="min-w-full bg-white">
                <thead class="bg-[#374151] text-white text-base">
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="w-1/3 px-4 py-2 text-left  font-medium  uppercase tracking-wider">Dosen</th>
                        <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">Semester</th>
                        <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">Mahasiswa</th>
                        <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">csc</th>
                        <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">scs</th>
