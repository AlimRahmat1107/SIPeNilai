            ...
            <table class="min-w-full bg-white">
                <thead class="bg-[#374151] text-white text-base">
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="w-1/3 px-4 py-2 text-left  font-medium  uppercase tracking-wider">Semester</th>
                        <th class="w-1/3 px-4 py-2 text-left  font-medium  uppercase tracking-wider">Mata Kuliah</th>
                ...
                <tbody class="text-gray-800 text-sm">
                    @foreach ($csc as $data)
                        <tr>
                            ...
                            <td class=" text-left py-3 px-4">{{ $data->curicullum->name }}</td>
                            <td class=" text-left py-3 px-4">{{ $data->semester->code }}</td>
                            <td class=" text-left py-3 px-4">{{ $data->course->name }}</td>
