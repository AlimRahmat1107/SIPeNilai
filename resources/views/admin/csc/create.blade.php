            ...
            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('csc.store') }}" method="POST"
                ...
                <div class="flex w-full justify-between mt-2">
                    <div class="w-[40%]">
                        ...
                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="curicullum_id">Kurikullum</label>
                            <select name="curicullum_id" id="curicullum_id"
                        ...
                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="course_id">Matakuliah</label>
