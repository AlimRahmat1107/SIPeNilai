            ...
            <div class="bg-white rounded-3xl w-[400px] h-auto py-8 px-8 ">
                ...
                <div>
                    <form action="{{route('register.create')}}" method="POST">
                        ...
                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="password">Konfirmasi Password</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="password"
                                name="password_confirmation" type="password" required placeholder="Masukan password">
                        </div>

                          <div class="mt-1 p-2 text-center">
                            <button class="bg-gray-500 hover:bg-[#374151] w-full p-2 rounded-2xl text-white">Tambahkan</button>
                            <a href="/login" class="border w-full p-2 rounded-2xl text-black mt-4 inline-block">Log In</a>
                        </div>
