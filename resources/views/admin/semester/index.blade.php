    ...
    <div class="w-11/12 mt-6 ml-10">
        <div class="mb-2 flex justify-between">
            <p class="text-xl pb-3 flex items-center">
                <i class="fas fa-list mr-3"></i> Table Semester
            </p>
            <div>
            <a href="/semester/create" class=" text-white block rounded-2xl py-2 px-4 border border-amber-300 bg-blue-400"> <i class="fas fa-plus"></i>  data</a>
        </div>
        </div>
            ...
            <table class="min-w-full bg-white">
                <thead class="bg-[#374151] text-white text-base">
                    <tr class="border-b border-gray-200">
                        ...
                        <th class="w-1/3 px-4 py-2 text-left  font-medium  uppercase tracking-wider">Kode Semester</th>
                        <th class="w-1/3 px-4 py-2 text-left  font-medium  uppercase tracking-wider"> Semester ke</th>
                        <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">Nama</th>
                        <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">Tahun Akademik</th>
                ...
                <tbody class="text-gray-800 text-sm">
                    @foreach ($semesters as $data)
                        <tr>
                            ...
                            <td class=" text-left py-3 px-4">{{ $data->semester_code }}</td>
                            <td class=" text-left py-3 px-4">{{ $data->number }}</td>
                            <td class=" text-left py-3 px-4">{{ $data->name }}</td>
                            <td class=" text-left py-3 px-4">{{ $data->academicYear->academic_year_code }}</td>
