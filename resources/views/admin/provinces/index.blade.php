...
<div class="w-11/12 mt-6 ml-10">
    <div class="mb-2 flex justify-between">
        <p class="text-xl pb-3 flex items-center">
            <i class="fas fa-list mr-3"></i> Table Provinsi
        </p>
        <form action="{{ route('province.import') }}" method="POST" enctype="multipart/form-data" class="flex w-[400px] justify-between  ">
            @csrf
            <div class="mt-2">
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody class="text-gray-700">
                ...
                <tr>
                    ...
                    <td class="w-1/3 text-left py-3 px-4">{{ $province->name }}</td>
