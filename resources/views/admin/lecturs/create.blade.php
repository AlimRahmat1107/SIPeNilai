...
@section('container')
    <div class="w-full mt-6 pl-0 lg:pl-2">
        ...
        <div class="leading-loose">
            <form class="p-10 bg-white rounded shadow-xl" action="{{ route('lectures.store') }}" method="POST"
                ...
                <div class="flex w-full justify-between mt-2">
                    <div class="w-[40%]">
                        ...
                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="nidn">Nidn</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="nidn" name="nidn"
                                type="text" required placeholder="Nidn">
                        </div>

                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="nip">Nip</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="nip" name="nip"
                                type="text" required placeholder="Nip">
                        </div>



                        <div class="mt-1 p-2">
                            <label class="block text-sm mb-1 text-gray-600" for="major_id">Jurusan</label>
