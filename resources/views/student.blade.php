                    ...
                    <table class="min-w-full bg-white">
                        <thead class="bg-[#374151] text-white text-base">
                            <tr class="border-b border-gray-200">
                                <th class="px-4 py-2 text-left  font-medium  uppercase tracking-wider">No
                                </th>
                                <th class="w-1/3 px-4 py-2 text-left  font-medium  uppercase tracking-wider">
                                    Username</th>
                                ...
                                <th class="w-1/3 text-left px-4 py-2 uppercase font-semibold ">Password
                                </th>
                                <th class="w-1/3 text-center px-4 py-2 uppercase font-semibold ">Action
                                </th>
                            </tr>
                        </thead>
